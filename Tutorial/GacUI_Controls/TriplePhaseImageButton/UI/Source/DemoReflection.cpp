...
#define _ ,
			...
			BEGIN_CLASS_MEMBER(::demo::TriplePhaseButton)
				ATTRIBUTE_TYPE(::vl::__vwsn::att_cpp_Friend, ::vl::reflection::description::GetTypeDescriptor(::vl::WString::Unmanaged(L"demo::TriplePhaseButtonConstructor")))
			...
			BEGIN_CLASS_MEMBER(::demo::TriplePhaseImageButtonTemplate)
				ATTRIBUTE_TYPE(::vl::__vwsn::att_cpp_Friend, ::vl::reflection::description::GetTypeDescriptor(::vl::WString::Unmanaged(L"demo::TriplePhaseImageButtonTemplateConstructor")))
