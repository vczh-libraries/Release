...
#define _ ,
			BEGIN_CLASS_MEMBER(::demo::ColorComboItemTemplate)
				ATTRIBUTE_TYPE(::vl::__vwsn::att_cpp_Friend, ::vl::reflection::description::GetTypeDescriptor(::vl::WString::Unmanaged(L"demo::ColorComboItemTemplateConstructor")))
			...
			BEGIN_CLASS_MEMBER(::demo::ColorListItemTemplate)
				ATTRIBUTE_TYPE(::vl::__vwsn::att_cpp_Friend, ::vl::reflection::description::GetTypeDescriptor(::vl::WString::Unmanaged(L"demo::ColorListItemTemplateConstructor")))
