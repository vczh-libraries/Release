...
#ifndef VCZH_WORKFLOW_COMPILER_GENERATED_EDITORBASEREFLECTION
#define VCZH_WORKFLOW_COMPILER_GENERATED_EDITORBASEREFLECTION
...
namespace vl
{
	namespace reflection
	{
		namespace description
		{
			...
			extern bool LoadEditorBaseTypes();
		}
	}
}
